...
job_name = 'glue-customer-churn-etl-pv'
...
project_name = 'customer-churn-pv' + dateAsString
# The name used when the Model is created
model_name='customer-churn-model-pv' + dateAsString
training_job_name = "CustomerChurnTrainingJob-pv" + dateAsString
